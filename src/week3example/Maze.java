...
public class Maze {
	...
	public List<MazeNode> dfs(int startRow, int startCol, int endRow, int endCol) {
		...
		// Do the search in a private method
		...
		LinkedList<MazeNode> path = recreatePath(start,goal,parentMap);
		return path;
	}
	...
	private LinkedList<MazeNode> recreatePath(MazeNode start, MazeNode goal,HashMap<MazeNode, MazeNode> parentMap){
